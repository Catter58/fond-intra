"""
Base Django settings for fond_intra project.
"""
import os
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Fond Intra API',
    'DESCRIPTION': 'Corporate Intranet Portal API',
    'VERSION': '1.0.0',
...
# =============================================================================
MAX_AVATAR_SIZE = int(os.environ.get('MAX_AVATAR_SIZE', 5242880))  # 5MB
MAX_ATTACHMENT_SIZE = int(os.environ.get('MAX_ATTACHMENT_SIZE', 10485760))  # 10MB
ALLOWED_AVATAR_TYPES = os.environ.get(
    'ALLOWED_AVATAR_TYPES',
    'image/jpeg,image/png,image/webp'
).split(',')

# Maximum upload size for request body
