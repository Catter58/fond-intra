...
import { ArrowLeft, Add, TrashCan, ChevronUp, ChevronDown } from '@carbon/icons-react'
      ...
      <Column lg={16} md={8} sm={4}>
        ...
        <div className="page-header mb-6">
          ...
          <p className="page-description">
            Создайте опрос для сотрудников компании
          </p>
        </div>
        ...
        {createMutation.isError && (
          <InlineNotification
            kind="error"
            title="Ошибка"
            subtitle="Не удалось создать опрос. Проверьте данные и попробуйте снова."
            hideCloseButton
            className="mb-4"
          />
        )}
